...
//-----------------------------------------------------------------------------------//
function preload() {
  //this.load.image("tiles", "../assets/library_map/base.png");
  //this.load.tilemapTiledJSON("map", "../assets/library_map/library_map.json");
  this.load.image("tiles", "../assets/gstown/tuxmon-sample-32px-extruded.png");
  //../assets/tilesets/tuxmon-sample-32px-extruded.png
  this.load.tilemapTiledJSON("map", "../assets/gstown/gstown.json");
...
function create() {
  ...
  worldLayer.setCollisionByProperty({ panda: true });
  ...
  // Tiled のtmxファイルに設定した"Spawn Point"からキャラクターの出現位置を決める。
